...
\begin{longtable}{|>{\centering\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{13cm}|}
    ...
    RF01 & O sistema deve permitir a inserção manual de itens na venda (peso e valor), bem como calcular automaticamente via leitura de código de barras. \\ 
    \hline
...
\begin{longtable}{|>{\centering\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{9cm}|>{\centering\arraybackslash}m{4cm}|}
    ...
    RN01 & A venda só pode ser registrada se o código de barras lido, ou inserido manualmente, for reconhecido e o item tiver estoque disponível. & RF01, RF02 \\ 
    \hline
