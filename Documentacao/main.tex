...
% ---
\subsection{Modelo Lógico de Dados (DER)}
% ---
...
A Figura \ref{fig:der_logico} apresenta o Diagrama Entidade-Relacionamento (DER) lógico do sistema CarneUp.

\begin{figure}[H]
    \caption{Diagrama Lógico de Dados (DER)}
