...
Diante desse cenário, a relevância do CarneUp reside na necessidade urgente de modernização deste setor. A solução proposta visa digitalizar e centralizar a gestão do açougue, oferecendo uma aplicação web robusta e com foco na facilidade de uso para o público-alvo. Ao implementar um controle de validade e de custos por fornecedor, o sistema impacta diretamente a eficiência operacional, o controle financeiro e a redução de desperdício.
...
\begin{itemize}
    ...
    \item Controle de Estoque (Entrada/Saída), incluindo marca, valor de custo e validade.
...
\begin{longtable}{|>{\centering\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{13cm}|}
    ...
    RF01 & O sistema deve permitir a inserção manual de itens na venda (peso e valor). \\ 
    \hline
    RF02 & O sistema deve permitir o registro de novas entradas de estoque (compras), incluindo valor de custo, marca e validade. \\ 
    \hline
    RF03 & O sistema deve permitir a busca e visualização de peças de estoque por fornecedor. \\ 
    \hline
    RF04 & O sistema deve calcular a margem de lucro de cada peça de carne vendida (Valor de Venda - Valor de Custo). \\ 
    \hline
    RF05 & O sistema deve emitir um alerta visual para o usuário quando a validade de uma peça de estoque estiver a 7 dias ou menos do vencimento. \\ 
    \hline
    RF06 & O sistema deve permitir o descarte de peças de estoque (baixa) e registrar o motivo do descarte (ex: vencimento, perda de qualidade). \\ 
    \hline
    RF07 & O sistema deve permitir a geração de relatórios de vendas, detalhando a quantidade e o valor total vendido. \\ 
    \hline
\end{longtable}
...
\begin{longtable}{|>{\centering\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{9cm}|>{\centering\arraybackslash}m{4cm}|}
    ...
    RN01 & A venda só pode ser registrada se o item tiver estoque disponível. & RF01, RF02 \\ 
    \hline
    RN02 & O valor de compra por peça deve ser registrado no momento da entrada no estoque para cálculo de margem de lucro. & RF03, RF05 \\ 
    \hline
    RN03 & O sistema deve manter o histórico de vendas para cada produto no estoque para fins de rastreabilidade. & RF04 \\ 
    \hline
    RN04 & A peça de carne vendida deve ter seu estoque subtraído em tempo real no momento do registro da venda. & RF02, RNF01 \\ 
    \hline
\end{longtable}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{2.5cm}|>{\raggedright\arraybackslash}m{12cm}|}
        ...
        \hline
        \textbf{Operável} & Todas as funcionalidades devem ser acessíveis via teclado, sem depender de mouse. \\ 
        \hline
