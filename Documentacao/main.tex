...
\begin{longtable}{|>{\centering\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{13cm}|}
    ...
    RF01 & O sistema deve calcular automaticamente o valor total da venda ao capturar o peso e o valor unitário do item lido via código de barras. \\ 
    \hline
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.9\textwidth]{Documentacao/Imagens/BD.jpg} % Certifique-se que o nome do arquivo é BD.jpg
    \fonte{Autoria própria (2025).}
\end{figure}
