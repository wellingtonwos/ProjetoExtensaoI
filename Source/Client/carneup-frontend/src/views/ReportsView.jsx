...
const SumCard = styled.div`
  ...
  p.val { font-family: 'Epilogue', sans-serif; font-size: 22px; font-weight: 900; color: var(--text); margin: 0; word-break: break-word; overflow-wrap: anywhere; white-space: normal; line-height: 1.05; }
  p.sub { font-size: 10px; color: var(--muted); margin: 3px 0 0; overflow-wrap: anywhere; word-break: break-word; white-space: normal; }
`
